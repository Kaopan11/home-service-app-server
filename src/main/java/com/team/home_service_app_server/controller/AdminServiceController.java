...
import com.team.home_service_app_server.dto.ReorderServicesRequest;
...
public class AdminServiceController {
	...
	@RequestMapping(path = { "", "/reorder" }, method = { RequestMethod.PATCH, RequestMethod.PUT })
	public AdminServiceListResponse reorder(@RequestBody(required = false) ReorderServicesRequest request) {
		return AdminServiceListResponse.success(adminCatalogService.reorder(request == null ? null : request.ids()));
	}
